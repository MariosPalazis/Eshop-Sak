...
class User {
  ...
  postLogin(capability, session, products) {
...
class FlashMessage {
  ...
  transferShoppingCart() {
    ...
    const standardContent = '<aside class="popup-container flash200" >' +
          `<p class="popup-message-flash200">Previous user left a shopping Cart!</p>` +
          `<p>Should we add it to yours?</p>` +
          `<button class="action-flash200">` +
          `<span class="yes-action-flash200">Yes!</span>` +
          `<span class="no-action-flash200">No!</span>` +
          `</button>` +
          '</aside>';
  ...
  loginResult(payload) {
    // this flashMessage id = flash100
    const standardContent = [
      '<aside class="popup-container flash100" >',
      '<p class="popup-logo"><img src="/assets/smalls/user.png" alt="popup-logo"></p>',
      '<p class="popup-close"><img src="/assets/smalls/close.svg" alt="close-window"></p>',
      '</aside>',
    ];
